              ...
              children: <Widget>[
                ...
                Align(
                  ...
                  child: FractionallySizedBox(widthFactor: 0.7,
                    child: RichText(
                      text: TextSpan(text: AppStrings.createA, style: AppTextStyles.s24w700l31.copyWith(color: AppColors.primaryColor),
                      children: [
                        TextSpan(text: AppStrings.smartpay, style: AppTextStyles.s24w700l31.copyWith(color: AppColors.secondaryColor),),
                        TextSpan(text: AppStrings.account, style: AppTextStyles.s24w700l31.copyWith(color: AppColors.primaryColor),),
                      ]),),
                  )
                  ),
                SizedBox(
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return AppStrings.fullNameErrorText;
                          } else {
                            return null;
                          }
                        },
                          ...
                          shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                              RoundedRectangleBorder(
                                  ...
                                  side: const BorderSide(color: AppColors.primaryColor))),
                                          ...
                                          onPressed: () async {
                                          //  appBloc!.add(SignInEvent(phone:_phoneTextEditingController.text,password:_passwordTextEditingController.text,context: context));
                                          },
                                          child:   isLoading ? const AppProgressIndicator() :  Padding(
                                            padding: const EdgeInsets.symmetric(vertical: 15.0),child: Text(AppStrings.signUp,style: AppTextStyles.s16w700l24,
                          ),
                        ),
                      ),
                    ],
